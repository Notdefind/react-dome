...
let appId = require('../config/env/development.config').beecloudAppId;

if (__PROD__) {
  appId = require('../config/env/production.config').beecloudAppId;
} else if (__TEST__) {
  appId = require('../config/env/test.config').beecloudAppId;
}
...
const webpackConfig = {
  ...
  resolve: {
    ...
    alias: {
      'platform': `${config.path_base}/config/env/${config.env}.config.js`,
    }
  },
  module: {
  },
